...
更新时间：2026-09-25。磁盘接续记录；不以此宣称调用了宿主原生 /compact 命令。
...
- 当前2D阶段：docs/assets/2d-candidates/ 有 A01–A08 玩家机器、B01–B06 怪物、C01–C06 挑战/修复共20张候选；用户筛选前冻结正式3D量产。现有GLB只保留为技术样件，最新试验副本在artifacts/qa/2d-freeze-3d-hold/。
